...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <!--<h1 class="logo mr-auto"><a href="<?php echo $this->baseurl; ?>"><?php echo $sitename; ?></a></h1>-->
      <!-- Uncomment below if you prefer to use an image logo -->
      <a href="<?php echo $this->baseurl; ?>" class="logo mr-auto"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>

			<a href="https://alexonbstudio.fr/documentation" class="get-started-btn scrollto">Documentation</a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <h2><em><?php echo htmlspecialchars($this->error->getMessage(), ENT_QUOTES, 'UTF-8'); ?></em></h2>
          <div class="d-lg-flex">
        ...
        <div class="row content">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0">
            <?php if (JModuleHelper::getModule('search')) : ?>
								...
								<p><a href="<?php echo $this->baseurl; ?>/index.php" class="btn-learn-more"><span class="far fa-home fa-4x"></span> <?php echo JText::_('JERROR_LAYOUT_HOME_PAGE'); ?></a></p>
